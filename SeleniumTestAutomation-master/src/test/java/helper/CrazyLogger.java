			...
			if(state.equals("online")){
				...
				case "chrome": 
					if(exceptionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, assertionMessage.toString(), "Microsoft Windows 10 - Chrome (Latest Version)");
					}
					else if(assertionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, exceptionMessage.toString(), "Microsoft Windows 10 - Chrome (Latest Version)");
					}
					break;
				case "firefox":
					if(exceptionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, assertionMessage.toString(), "Microsoft Windows 10 - Firefox (Latest Version)");
					}
					else if(assertionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, exceptionMessage.toString(), "Microsoft Windows 10 - Firefox (Latest Version)");
					}
					break;
				case "edge":
					if(exceptionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, assertionMessage.toString(), "Microsoft Windows 10 - Edge (Latest Version)");
					}
					else if(assertionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, exceptionMessage.toString(), "Microsoft Windows 10 - Edge (Latest Version)");
					}
					break;
				case "safari":
					if(exceptionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, assertionMessage.toString(), "Apple Mac OS (Virtual) - Safari (Latest Version)");
					}
					else if(assertionMessage == null){
						zph.postExecutionResult(className.replace("_", "-"), executionCycle, "jimmy", "Fail", counter, exceptionMessage.toString(), "Apple Mac OS (Virtual) - Safari (Latest Version)");
					}
					break;
					default:
						break;
